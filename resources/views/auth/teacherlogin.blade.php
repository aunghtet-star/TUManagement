            ...
            <div class="container"> <!-- Normal container -->
                <div class="row align-items-center min-vh-100"> <!-- Vertical center -->
                    ...
                    <div class="col-md-6 d-none d-md-block">
                        <div class="p-3">
                            <img src="{{ asset('admin.png') }}" alt="Login Image"
                                class="img-fluid rounded-4 w-100" style="height: 380px">
                        </div>
                    </div>

                    <!-- Right Side Login Form (centered) -->
                    <div class="col-md-6 d-flex justify-content-center">
                        <form class="login-form p-5 rounded-4 w-100" method="POST" action="{{ route('teacher.login.post') }}"
