...
<section id="header">
            ...
            <div class="container-fluid col-md-10">
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-style" href="{{ route('teacher.login') }}">Teacher Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-style" href="{{ route('student.login') }}">Student Login</a>
                        </li>
                    </ul>
                    <!-- <form class="d-flex">
    ...
    <section id="home" class="bg-light">
        <div class="relative-container">
            ...
            <div class="text-overlay">
                <p class="text-style">Welcome To Kyaukse Technological University </p>
            </div>
        </div>
        <div class="container-fluid col-md-10 mt-3 p-3">
            <div class="row section-theme">
                ...
                <div class="col-md-5 order-md-1 mt-4 p-4">
                    <div>
                        <h4 class="text-dark text-center">KTU UNIVERSITY INFORMATION MANAGEMENT SYSTEM </h4>
                        <p class='text-dark py-3 text-center mb-3'>KTU University Information Management System is a
      ...
      <section id="features" class="bg-light">
        <div class="container-fluid col-md-10 mx-auto">
            <div class="text-center mt-3">
                ...
                <p class="texts text-center font-style">Features of KTU University Information Management System</p>
            </div>
    ...
    <section id="about">
        <div class="container-fluid col-md-10 mx-auto">
            <div>
                <div>
                    <h2 class="font-style py-3 text-center mt-3">ABOUT KTU </h2>
