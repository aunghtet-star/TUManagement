        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body align-items-center m-4">
                    <h3 class="text-dark mb-3"> Update Assignment & Pratical File</h3>
                    ...
                    <form action="{{ route('assignment.update',$assignment->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mt-3 mb-2 col-auto">
                            ...
                            <select name="year_id" id="year_id" class="form-control @error('year_id') is-invalid @enderror">
                                @foreach(sortYears($years) as $year)
                                    <option value="{{ $year['id'] }}" {{ $year['id'] == $assignment->year_id ? 'selected' : '' }}>{{ $year['name'] }} - {{ $year['semester'] }}</option>
                                @endforeach
                            </select>
                            @error('year_id')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-auto">
                            <label class="col-form-label">Subject <small class="text-danger">*</small></label>
                            <input type="text" class="form-control @error('type') is-invalid @enderror" name="subject" value="{{ old('subject',$assignment->subject) }}">
                            @error('subject')
                        ...
                        <div class="col-auto">
                            ...
                            <input type="file"  class="form-control" value="{{ $assignment->assigment_file }}" name="assigment_file" multiple>
                        ...
                        <div class="col-sm mt-3">
                            <a href="{{ route('assignment.index') }}" class="btn btn-outline-dark">Back</a>
