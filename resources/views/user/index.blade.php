...
$(document).ready(function() {
    new DataTable('#userTable', {
        ...
        pageLength: 8,        // တစ်မျက်နှာမှာ ပြမဲ့ row အရေအတွက်
        lengthMenu: [5, 10, 25, 50, 100], // user ကိုရွေးခွင့်ပေးမဲ့ row အရေအတွက်
        searching: true,       // search box enable
        ordering: true,        // sorting enable
        info: true             // "Showing 1 to 10 of 50 entries" info enable
    });
});
