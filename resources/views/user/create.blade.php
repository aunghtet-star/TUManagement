                        ...
                        <div id="position-field" style="display: none;">
                            <div class="col-auto">
                                ...
                                <select class="form-control @error('position') is-invalid @enderror" name="position">
                                    ...
                                    <option value="Tutor" {{ old('position') == 'Tutor' ? 'selected' : '' }}>Tutor</option>
                                </select>
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="d" class="form-control @error('d') is-invalid @enderror" name="d">
                                        <option value="" disabled selected>Select Department</option>
                                         <option value="IT" {{ old('d') == 'IT' ? 'selected' : '' }}>IT</option>
                                        ...
                                        <option value="MP" {{ old('d') == 'MP' ? 'selected' : '' }}>MP</option>
                                        <option value="MC" {{ old('d') == 'MC' ? 'selected' : '' }}>MC</option>
                                        <option value="Met" {{ old('d') == 'Met' ? 'selected' : '' }}>Met</option>
                                        <option value="NE" {{ old('d') == 'NE' ? 'selected' : '' }}>NE</option>
                                        <option value="BioT" {{ old('d') == 'BioT' ? 'selected' : '' }}>BioT</option>
                                    </select>
