            ...
            <div class="card">
                ...
                <div class="card-body align-items-center m-4">
                    ...
                    <form action="{{ route('timetable.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-auto">
                            <label class="col-form-label">Timetable Type<small class="text-danger">*</small></label>
                            <input type="text" class="form-control @error('type') is-invalid @enderror" name="timetable_type" value="{{ old('timetable_type') }}">
