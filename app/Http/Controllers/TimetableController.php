...
class TimetableController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // filter မသုံးပဲ စမ်းကြည့်ပါ
        $timetables = Timetable::with('department', 'year')->paginate(5);

        // dd($timetables->toArray()); // အရင်စမ်းချင်ရင် ဒီလို ထုတ်ကြည့်ပါ
    ...
    public function store(StoreTimetableRequest $request)
    {
        ...
        $timetable->timetable_type = $request->timetable_type;
        $timetable->save();
