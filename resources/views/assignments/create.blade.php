        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body align-items-center m-4">
                    <h3 class="text-dark mb-3"> Create Assignment & Pratical File</h3>
                    ...
                    <form action="{{ route('assignment.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-auto">
                            ...
                            <input type="text" class="form-control @error('type') is-invalid @enderror" name="subject" value="{{ old('subject') }}">
                            @error('subject')
                        ...
                        <div class="col-auto">
                            ...
                            <input type="file"  class="form-control" name="assigment_file" multiple>
