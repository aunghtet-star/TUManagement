                    ...
                    <form action="{{ route('user.update', $user->id)}}" method="post" onsubmit="return handleSubmit(event)">
                        ...
                        <div id="position-field" style="display: none;">
                            <div class="col-auto">
                                ...
                                <select class="form-control @error('position') is-invalid @enderror" name="position">
                                    ...
                                    <option value="Tutor" {{ old('position', $user->position) == 'Tutor' ? 'selected' : '' }}>Tutor</option>
                                </select>
                                @error('position')
                                    <div class="text-danger">*{{$message}}</div>
                                @enderror
                        ...
                        <div id="student-field" style="display: none;">
                            <div class="col-auto">
                                ...
                                <div class="input-group">
                                    <select id="y" class="form-control @error('y') is-invalid @enderror" name="y">
                                        ...
                                        <option value="I" {{ old('y', $user->roll_part1) == 'I' ? 'selected' : '' }}>I</option>
                                        <option value="II" {{ old('y', $user->roll_part1) == 'II' ? 'selected' : '' }}>II</option>
                                        <option value="III" {{ old('y', $user->roll_part1) == 'III' ? 'selected' : '' }}>III</option>
                                        <option value="IV" {{ old('y', $user->roll_part1) == 'IV' ? 'selected' : '' }}>IV</option>
                                    </select>
                                    ...
                                    <select id="d" class="form-control @error('d') is-invalid @enderror" name="d">
                                        ...
                                        <option value="IT" {{ old('d', $user->roll_part2) == 'IT' ? 'selected' : '' }}>IT</option>
                                        <option value="CIVIL" {{ old('d', $user->roll_part2) == 'CIVIL' ? 'selected' : '' }}>CIVIL</option>
                                        <option value="EP" {{ old('d', $user->roll_part2) == 'EP' ? 'selected' : '' }}>EP</option>
                                        <option value="EC" {{ old('d', $user->roll_part2) == 'EC' ? 'selected' : '' }}>EC</option>
                                        <option value="MP" {{ old('d', $user->roll_part2) == 'MP' ? 'selected' : '' }}>MP</option>
                                        <option value="MC" {{ old('d', $user->roll_part2) == 'MC' ? 'selected' : '' }}>MC</option>
                                        <option value="Met" {{ old('d', $user->roll_part2) == 'Met' ? 'selected' : '' }}>Met</option>
                                        <option value="NE" {{ old('d', $user->roll_part2) == 'NE' ? 'selected' : '' }}>NE</option>
                                        <option value="BioT" {{ old('d', $user->roll_part2) == 'BioT' ? 'selected' : '' }}>BioT</option>

                                    </select>
                                    <input type="number" id="roll_number" class="form-control @error('roll_number') is-invalid @enderror" name="roll_number" value="{{ old('roll_number', $user->roll_number_only) }}" placeholder="Number">
                            ...
                            <div class="col-auto">
                                ...
                                <input type="text" class="form-control @error('registration_no') is-invalid @enderror" name="registration_no" value="{{ old('registration_no', $user->registration_no) }}">
