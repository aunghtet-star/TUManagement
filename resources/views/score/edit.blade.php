        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body align-items-center m-4">
                    <h3 class="text-dark mb-3"> Update Admission Scores </h3>
                    ...
                    <form action="{{ route('score.update', $score->id) }}" method="post">
                        ...
                        <div class="col-auto">
                            ...
                            <select class="form-control @error('gender') is-invalid @enderror" name="gender">
                                ...
                                <option value="male" {{ old('gender', $score->gender) == 'male' ? 'selected' : '' }}>Male</option>
                                <option value="female" {{ old('gender', $score->gender) == 'female' ? 'selected' : '' }}>Female</option>
                            </select>
                            @error('gender')
                        ...
                        <div class="col-auto">
                            ...
                            <input type="text" class="form-control @error('highest_score') is-invalid @enderror" name="highest_score" value="{{ $score->highest_score }}">
                        ...
                        <div class="col-auto">
                            ...
                            <input type="text" class="form-control @error('lowest_score') is-invalid @enderror" name="lowest_score" value="{{ $score->lowest_score }}">
