            ...
            <div class="container"> <!-- Normal container -->
                <div class="row align-items-center min-vh-100"> <!-- Vertical center -->
                    ...
                    <div class="col-md-6 d-none d-md-block">
                        <div class="p-3 pl-5">
                            <img style="max-width: 500px;" src="{{ asset('images_3.jpeg') }}" alt="Login Image"
                    ...
                    <div class="col-md-6 d-flex justify-content-center">
                        <form class="login-form p-5 rounded-4 w-100" method="POST" action="{{ route('student.login.post') }}" style="max-width: 700px;">
                            @csrf
